            ...
            for (int i = 0; i < numPro; i++)
            {
                if (reponse == "y")
                {
                   ...
                   // Pro = new(id, temparriv, duree, prio);
                    ...
                    else { Pro = new Processus(id, temparriv, duree, prio); }
                    Console.WriteLine("");
                }
                else
                {
                    ...
                    else { Pro = new Processus(i, r2.Next(0, 15), r3.Next(1, 15), r4.Next(1, 5)); }
                }
